...
def make_window(theme):
    ...
    input_layout =  [
                ...
                [sg.Combo(values=('vqgan_imagenet_f16_16384', 'vqgan_faceshq', 'vqgan_imagenet_f16_1024', 'wikiart_16384'), default_value='Model', readonly=True,  k='-COMBO1-'),
                 sg.Combo(values=('412', '288', '512', '-------'), default_value='Width', readonly=True,  k='-COMBO2-'),
                 sg.Combo(values=('412', '288', '512', '-------'), default_value='Height', readonly=True,  k='-COMBO3-'),
                 sg.Combo(values=('400', '500', '600', '-------'), default_value='Iterations', readonly=True,  k='-COMBO4-'),
                 sg.Combo(values=('125', '150', '175', '200', '-------'), default_value='Diffusion', readonly=True,  k='-COMBO5-'),],
    ...
    layout = [ [sg.MenubarCustom(menu_def, key='-MENU-', font='Courier 15', tearoff=True)],
                [sg.Text('BATbot Startup', size=(38, 1), justification='center', font=("Helvetica", 16), relief=sg.RELIEF_RIDGE, k='-TEXT HEADING-', enable_events=True)]]
    ...
    window = sg.Window('BATbot Startup', layout, right_click_menu=right_click_menu_def, right_click_menu_tearoff=True, grab_anywhere=True, resizable=True, margins=(0,0), use_custom_titlebar=True, finalize=True, keep_on_top=True,
                       # scaling=2.0,
                       )
