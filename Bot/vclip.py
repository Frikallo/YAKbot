...
def parse():
    ...
    vq_parser.add_argument("-ckpt", "--vqgan_checkpoint", type=str, help="VQGAN checkpoint", default=f'{model}.ckpt',
                           dest='vqgan_checkpoint')
    vq_parser.add_argument("-conf", "--vqgan_config", type=str, help="VQGAN config", default=f'{model}.yaml', dest='vqgan_config')
    ...
    vq_parser.add_argument("-i",    "--iterations", type=int, help="Number of iterations", default=max_iterations, dest='max_iterations')
    ...
    vq_parser.add_argument("-o",    "--output", type=str, help="Output filename", default="progress.png", dest='output')
    ...
    vq_parser.add_argument("-p",    "--prompts", type=str, help="Text prompts", default=prompt, dest='prompts')
    vq_parser.add_argument("-s",    "--size", nargs=2, type=int, help="Image size (width height) (default: %(default)s)",
                           default=[width, height], dest='size')
    vq_parser.add_argument("-sd",   "--seed", type=int, help="Seed", default=seed, dest='seed')
