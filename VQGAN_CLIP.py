...
import taming_transformers.taming.modules 
import torch
...
model_names={"vqgan_imagenet_f16_16384": 'ImageNet 16384',"vqgan_imagenet_f16_1024":"ImageNet 1024", 'vqgan_openimages_f16_8192':'OpenImages 8912',
                 "wikiart_1024":"WikiArt 1024", "wikiart_16384":"WikiArt 16384", "coco":"COCO-Stuff", "vqgan_faceshq":"FacesHQ", "sflckr":"S-FLCKR"}
...
for i in range(init_frame,last_frame): #
    frames.append(Image.open("C:\\Users\\noahs\\OneDrive\\Desktop\\Bot\\steps\\"+ str(i) +'.png'))
    size = (width,height)
